    ...
    <div>
            <svg width="1000" height="650">
                <g transform="translate(30,20)">
                    ...
                    path="M-25,-12.5 L45,-12.5 L 0,-87.5 z" />
                    </text>
                </g>
        ...
        >
            ...
            <img src={`${Img2}`} style={{ height:'460px', width:'460px', marginRight: '500px'}}  alt={'1'}/>  
        </Parallax>
        <Parallax
            blur={{ min: -15, max: 15 }}
            bgImage={`${Blackbox}`}
        ...
        >
            ...
            <img src={`${Imga}`} style={{ height:'650px', width:'650px', marginLeft: '250px', marginBottom: '200px'}}  alt={'1'}/> 
        </Parallax>
        <Parallax
            blur={{ min: -25, max: 5 }}
            bgImage={`${Whitebox}`}
        ...
        >
            ...
            <img src={`${Img3}`} style={{ height:'900px', width:'900px', marginLeft: '400px', marginBottom: '200px'}}  alt={'1'}/>  
        </Parallax>
